...
const AllTicketsDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-base-100 py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-base-200 rounded-2xl shadow-xl overflow-hidden">
          <div className="relative h-64 sm:h-80 md:h-96 w-full">
            <img
              ...
              className="w-full h-full object-cover"
            />
            <div className="absolute top-4 right-4 bg-base-100/90 backdrop-blur px-5 py-2 rounded-2xl shadow-lg border border-primary/20">
              <span className="text-3xl font-extrabold text-primary">
                ${price}
              </span>
            </div>
          ...
          <div className="p-6 md:p-8">
            <div className="mb-6">
              <div className="flex flex-wrap items-center gap-3 mb-3">
                ...
                <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-semibold shadow-sm border border-primary/20">
                  {transportType}
                </span>
              </div>

              <div className="flex items-center gap-2 text-lg text-neutral/80">
                <MapPin className="w-5 h-5 text-primary" />
                <span className="font-semibold">{fromLocation}</span>
            ...
            {!isPastDeparture ? (
              <div className="mb-6 p-4 bg-primary/5 border border-primary/20 rounded-xl shadow-sm">
                <h3 className="text-sm font-semibold text-neutral/70 mb-2 flex items-center gap-2">
                  <Clock className="w-4 h-4 text-primary" />
                  Time Until Departure
                </h3>
                <div className="grid grid-cols-4 gap-4 text-center">
              ...
              <div className="mb-6 p-4 bg-error/10 border border-error/30 rounded-xl shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <Calendar className="w-5 h-5 text-neutral/60 mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Package className="w-5 h-5 text-neutral/60 mt-1" />
                  <div>
                    <p className="text-sm text-neutral/60">Available Tickets</p>
                    <p className="text-lg font-semibold text-neutral">
                      {quantity}{" "}
                      {quantity === 0 && (
                        <span className="text-error text-sm">(Sold Out)</span>
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  <DollarSign className="w-5 h-5 text-neutral/60 mt-1" />
                  <div>
                    <p className="text-sm text-neutral/60">Price per Ticket</p>
                    <p className="text-lg font-semibold text-neutral">
                      ${price}
                    </p>
                  </div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {perks.map((perk, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-2 bg-primary/5 border border-primary/20 p-3 rounded-xl shadow-sm"
                    >
                      <div className="w-2 h-2 bg-primary rounded-full" />
                      <span className="text-neutral/90">{perk}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-base-200 rounded-2xl max-w-md w-full p-6 relative shadow-xl">
            <button
              onClick={() => {
                setIsModalOpen(false);
                reset();
              }}
              className="absolute top-4 right-4 text-primary transition hover:text-secondary"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-base-100 border border-neutral/20 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent text-neutral"
                />
                {errors.bookingQuantity && (
              ...
              <div className="bg-base-300 p-4 rounded-xl">
                <div className="flex justify-between mb-2 text-neutral/60">
                  <span>Price per ticket:</span>
                  <span className="font-semibold">${price}</span>
                </div>
                <div className="flex justify-between mb-2 text-neutral/60">
                ...
                <div className="border-t border-neutral/20 pt-2 flex justify-between items-center">
              ...
              <button
                ...
                className="w-full bg-primary text-white py-3 rounded-xl font-semibold shadow-md hover:bg-secondary transition"
              >
                Confirm Booking
              </button>
            </div>
